...
public final class Monitor {
    ...
    public boolean enterWhen(com.google.common.util.concurrent.Monitor.Guard r12, long r13, java.util.concurrent.TimeUnit r15) throws java.lang.InterruptedException {
        ...
        L_0x0033:
            r6 = 0
            r8 = 1
            boolean r9 = r12.isSatisfied()     // Catch:{ all -> 0x0066 }
            ...
            goto L_0x0048
        L_0x0044:
            long r9 = remainingNanos(r4, r0)     // Catch:{ all -> 0x0066 }
        L_0x0048:
            boolean r9 = r11.awaitNanos(r12, r9, r3)     // Catch:{ all -> 0x0066 }
        ...
        L_0x0066:
            ...
            r11.signalNextWaiter()     // Catch:{ all -> 0x0071 }
            goto L_0x0076
        L_0x0071:
            r7 = move-exception
            r2.unlock()
