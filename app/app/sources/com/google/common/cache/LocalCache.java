...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        public /* synthetic */ void m2035lambda$loadAsync$0$comgooglecommoncacheLocalCache$Segment(Object key, int hash, LoadingValueReference loadingValueReference, ListenableFuture loadingFuture) {
            try {
        ...
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public boolean storeLoadedValue(K r21, int r22, com.google.common.cache.LocalCache.LoadingValueReference<K, V> r23, V r24) {
            /*
                r20 = this;
                r7 = r20
                r8 = r21
                r9 = r22
                r20.lock()
                com.google.common.cache.LocalCache<K, V> r0 = r7.map     // Catch:{ all -> 0x0107 }
                com.google.common.base.Ticker r0 = r0.ticker     // Catch:{ all -> 0x0107 }
                long r0 = r0.read()     // Catch:{ all -> 0x0107 }
                r10 = r0
                r7.preWriteCleanup(r10)     // Catch:{ all -> 0x0107 }
                int r0 = r7.count     // Catch:{ all -> 0x0107 }
                r12 = 1
                int r0 = r0 + r12
                int r1 = r7.threshold     // Catch:{ all -> 0x0107 }
                if (r0 <= r1) goto L_0x0024
                r20.expand()     // Catch:{ all -> 0x0107 }
                int r1 = r7.count     // Catch:{ all -> 0x0107 }
                int r0 = r1 + 1
            L_0x0024:
                java.util.concurrent.atomic.AtomicReferenceArray<com.google.common.cache.ReferenceEntry<K, V>> r1 = r7.table     // Catch:{ all -> 0x0107 }
                r13 = r1
                int r1 = r13.length()     // Catch:{ all -> 0x0107 }
                int r1 = r1 - r12
                r14 = r9 & r1
                java.lang.Object r1 = r13.get(r14)     // Catch:{ all -> 0x0107 }
                com.google.common.cache.ReferenceEntry r1 = (com.google.common.cache.ReferenceEntry) r1     // Catch:{ all -> 0x0107 }
                r15 = r1
                r6 = r1
            L_0x0036:
                if (r6 == 0) goto L_0x00df
                java.lang.Object r1 = r6.getKey()     // Catch:{ all -> 0x0107 }
                r5 = r1
                int r1 = r6.getHash()     // Catch:{ all -> 0x0107 }
                if (r1 != r9) goto L_0x00d5
                if (r5 == 0) goto L_0x00d5
                com.google.common.cache.LocalCache<K, V> r1 = r7.map     // Catch:{ all -> 0x0107 }
                com.google.common.base.Equivalence<java.lang.Object> r1 = r1.keyEquivalence     // Catch:{ all -> 0x0107 }
                boolean r1 = r1.equivalent(r8, r5)     // Catch:{ all -> 0x0107 }
                if (r1 == 0) goto L_0x00d1
                com.google.common.cache.LocalCache$ValueReference r1 = r6.getValueReference()     // Catch:{ all -> 0x0107 }
                r4 = r1
                java.lang.Object r1 = r4.get()     // Catch:{ all -> 0x0107 }
                r16 = r1
                r3 = r23
                if (r3 == r4) goto L_0x008c
                if (r16 != 0) goto L_0x006b
                com.google.common.cache.LocalCache$ValueReference<java.lang.Object, java.lang.Object> r1 = com.google.common.cache.LocalCache.UNSET     // Catch:{ all -> 0x0107 }
                ...
                goto L_0x0092
            L_0x006b:
                com.google.common.cache.RemovalCause r12 = com.google.common.cache.RemovalCause.REPLACED     // Catch:{ all -> 0x0107 }
                r17 = 0
                r1 = r20
                r2 = r21
                r3 = r22
                ...
                r17 = r6
                r6 = r12
                r1.enqueueNotification(r2, r3, r4, r5, r6)     // Catch:{ all -> 0x0107 }
                r20.unlock()
            ...
            L_0x008c:
                ...
                r17 = r6
            L_0x0092:
                int r1 = r7.modCount     // Catch:{ all -> 0x0107 }
                int r1 = r1 + r12
                r7.modCount = r1     // Catch:{ all -> 0x0107 }
                boolean r1 = r23.isActive()     // Catch:{ all -> 0x0107 }
                if (r1 == 0) goto L_0x00b6
                if (r16 != 0) goto L_0x00a2
                com.google.common.cache.RemovalCause r1 = com.google.common.cache.RemovalCause.COLLECTED     // Catch:{ all -> 0x0107 }
                goto L_0x00a4
            L_0x00a2:
                com.google.common.cache.RemovalCause r1 = com.google.common.cache.RemovalCause.REPLACED     // Catch:{ all -> 0x0107 }
            L_0x00a4:
                r6 = r1
                int r5 = r23.getWeight()     // Catch:{ all -> 0x0107 }
                r1 = r20
                r2 = r21
                r3 = r22
                r4 = r16
            ...
            L_0x00b6:
                ...
                r4 = r24
                r5 = r10
                r1.setValue(r2, r3, r4, r5)     // Catch:{ all -> 0x0107 }
                r7.count = r0     // Catch:{ all -> 0x0107 }
                r1 = r17
                r7.evictEntries(r1)     // Catch:{ all -> 0x0107 }
                r20.unlock()
                r20.postWriteCleanup()
                return r12
            L_0x00d1:
            ...
            L_0x00d5:
                ...
                r1 = r6
            L_0x00d8:
                com.google.common.cache.ReferenceEntry r2 = r1.getNext()     // Catch:{ all -> 0x0107 }
                r6 = r2
                goto L_0x0036
            L_0x00df:
                r1 = r6
                ...
                int r1 = r1 + r12
                r7.modCount = r1     // Catch:{ all -> 0x0107 }
                com.google.common.cache.ReferenceEntry r1 = r7.newEntry(r8, r9, r15)     // Catch:{ all -> 0x0107 }
                r5 = r1
                r1 = r20
                r2 = r5
                r3 = r21
                ...
                r5 = r10
                r1.setValue(r2, r3, r4, r5)     // Catch:{ all -> 0x0107 }
                r13.set(r14, r12)     // Catch:{ all -> 0x0107 }
                r7.count = r0     // Catch:{ all -> 0x0107 }
                r7.evictEntries(r12)     // Catch:{ all -> 0x0107 }
                r20.unlock()
                r20.postWriteCleanup()
                r1 = 1
                return r1
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V> {
        ...
        public /* synthetic */ Object m2034lambda$loadFuture$0$comgooglecommoncacheLocalCache$LoadingValueReference(Object newResult) {
            set(newResult);
            return newResult;
        }
