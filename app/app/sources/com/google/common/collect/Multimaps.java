...
public final class Multimaps {
    ...
    private static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        public Collection<V2> m2037lambda$createAsMap$0$comgooglecommoncollectMultimaps$TransformedEntriesMultimap(@ParametricNullness K key, Collection<V1> values) {
        ...
        public Collection<V2> get(@ParametricNullness K key) {
            return m2037lambda$createAsMap$0$comgooglecommoncollectMultimaps$TransformedEntriesMultimap(key, this.fromMultimap.get(key));
        }
        ...
        public Collection<V2> removeAll(@CheckForNull Object key) {
            return m2037lambda$createAsMap$0$comgooglecommoncollectMultimaps$TransformedEntriesMultimap(key, this.fromMultimap.removeAll(key));
        }
    ...
    static final class AsMap<K, V> extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
        ...
        class EntrySet extends Maps.EntrySet<K, Collection<V>> {
            ...
            public /* synthetic */ Collection m2036lambda$iterator$0$comgooglecommoncollectMultimaps$AsMap$EntrySet(Object key) {
