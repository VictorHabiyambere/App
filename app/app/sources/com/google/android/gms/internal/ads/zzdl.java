...
public class zzdl {
    ...
    public static final zzdl zza = new zzdl(new zzdk());
    ...
    @Deprecated
    public static final zzdl zzb = zza;
    @Deprecated
    public static final zzn zzc = new zzdh();
    ...
    protected zzdl(zzdk zzdk) {
        ...
        this.zzB = false;
        this.zzC = false;
        this.zzD = zzgbf.zzc(zzdk.zzp);
        this.zzE = zzgbh.zzl(zzdk.zzq);
    }
    ...
    public boolean equals(Object obj) {
        ...
        zzdl zzdl = (zzdl) obj;
        return this.zzn == zzdl.zzn && this.zzl == zzdl.zzl && this.zzm == zzdl.zzm && this.zzo.equals(zzdl.zzo) && this.zzq.equals(zzdl.zzq) && this.zzu.equals(zzdl.zzu) && this.zzv.equals(zzdl.zzv) && this.zzw.equals(zzdl.zzw) && this.zzx == zzdl.zzx && this.zzD.equals(zzdl.zzD) && this.zzE.equals(zzdl.zzE);
    }
