...
public final class zzaxj {
    private static Cipher zza = null;
    ...
    public final String zza(byte[] bArr, byte[] bArr2) throws zzaxi {
        ...
        try {
            ...
            throw new zzaxi(this, e);
        } catch (InvalidKeyException e2) {
            throw new zzaxi(this, e2);
        } catch (IllegalBlockSizeException e3) {
            throw new zzaxi(this, e3);
        } catch (NoSuchPaddingException e4) {
            throw new zzaxi(this, e4);
        } catch (BadPaddingException e5) {
            throw new zzaxi(this, e5);
        }
    }
    ...
    public final byte[] zzb(byte[] bArr, String str) throws zzaxi {
        ...
        try {
            ...
            throw new zzaxi(this, e6);
        } catch (IllegalArgumentException e7) {
            throw new zzaxi(this, e7);
        }
    }
}
