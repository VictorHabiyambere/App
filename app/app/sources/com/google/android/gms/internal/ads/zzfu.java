...
public final class zzfu {
    ...
    private final int zzO(Charset charset) {
        ...
        if (charset.equals(zzfxs.zzc) || charset.equals(zzfxs.zza)) {
            ...
            int i3 = this.zze;
            if (i2 - i3 > 0) {
                b = (byte) zzgdx.zza((long) (this.zzd[i3] & 255));
                return (zzgdx.zza((long) b) << 16) + i;
            }
        }
        if (charset.equals(zzfxs.zzf) || charset.equals(zzfxs.zzd)) {
            ...
            if (i4 - i5 >= 2) {
                byte[] bArr = this.zzd;
                b = (byte) zzgdx.zzb(bArr[i5], bArr[i5 + 1]);
                i = 2;
                return (zzgdx.zza((long) b) << 16) + i;
            }
        }
        ...
        byte[] bArr2 = this.zzd;
        b = (byte) zzgdx.zzb(bArr2[i7 + 1], bArr2[i7]);
        i = 2;
        return (zzgdx.zza((long) b) << 16) + i;
    }
    ...
    public final int zzi() {
        ...
        this.zze = i4;
        this.zze = i4 + 1;
        return ((bArr[i4] & 255) << Ascii.CAN) | (bArr[i] & 255) | ((bArr[i2] & 255) << 8) | ((bArr[i3] & 255) << Ascii.DLE);
    }
