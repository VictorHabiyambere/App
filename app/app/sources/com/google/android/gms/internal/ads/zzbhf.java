...
public final class zzbhf extends zzbhn {
    ...
    private static final int zzc = Color.rgb(12, 174, ComposerKt.referenceKey);
    ...
    public zzbhf(String str, List list, Integer num, Integer num2, Integer num3, int i, int i2, boolean z) {
        int i3;
        int i4;
        this.zzd = str;
        for (int i5 = 0; i5 < list.size(); i5++) {
            zzbhi zzbhi = (zzbhi) list.get(i5);
            this.zze.add(zzbhi);
            this.zzf.add(zzbhi);
        }
        if (num != null) {
