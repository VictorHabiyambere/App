...
public final class ClientCalls {
    ...
    public static <ReqT, RespT> RespT blockingUnaryCall(io.grpc.Channel r6, io.grpc.MethodDescriptor<ReqT, RespT> r7, io.grpc.CallOptions r8, ReqT r9) {
        /*
            ...
            com.google.common.util.concurrent.ListenableFuture r3 = futureUnaryCall(r2, r9)     // Catch:{ RuntimeException -> 0x0045, Error -> 0x003f }
        L_0x001a:
            boolean r4 = r3.isDone()     // Catch:{ RuntimeException -> 0x0045, Error -> 0x003f }
        ...
        L_0x0024:
            ...
            r2.cancel(r5, r4)     // Catch:{ RuntimeException -> 0x0045, Error -> 0x003f }
            goto L_0x0023
        L_0x002c:
            r0.shutdown()     // Catch:{ RuntimeException -> 0x0045, Error -> 0x003f }
            java.lang.Object r4 = getUnchecked(r3)     // Catch:{ RuntimeException -> 0x0045, Error -> 0x003f }
